...
import com.example.cursomc.CursomcApplication;
...
public class DBService {
	...
	public void instantiateDateBase () throws ParseException {
		...
		categoriaRepository.save(Arrays.asList(cat1, cat2,cat3,cat4,cat5,cat6,cat7)); // salva todas categorias
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "maria@gmail.com","231313313",TipoCliente.PESSOAFISICA);
